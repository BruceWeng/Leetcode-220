...
|:--------------:|:---:|:-----------------------:|:-:|---------------------------------------- |:-------:|:-------:|
| A.Tabulation   | 1.1 | Conbination DP          | 1 | 55. Jump Game                           | &check; | &check; |
| Recursion/Memo |     |                         | 2 | 62. Unique Paths                        | &check; | &check; |
...
|                | 1.2 | Local/Global DP         | 1 | 128. Longest Consecutive Sequence       | &check; | &check; |
|                |     |                         | 2 | 134. Gas Station                        | &check; | &check; |
|                |     |                         | 3 | 221. Maximal Square                     | &check; | &check; |
|                |     |                         | 4 | 279. Perfect Squares                    | &check; | &check; |
|                | 1.3 | Kadane DP               | 1 | 53. Maximum Subarray                    |         | &check; |
|                |     |                         | 2 | 152. Maximum Product Subarray           |         | &check; |
|                | 1.4 | Decision Making DP      | 1 | 198. House Robber                       | &check; | &check; |
...
|                | 1.5 | Two String Matching DP  | 1 | 5. Longest Palindromic Substring        | &check; | &check; |
...
|                | 1.6 | Two Direction DP        | 1 | 11. Container With Most Water           | &check; | &check; |
...
|                | 2.3 | Divide and Conquer DFS | 1 | 23 Merge k Sorted Lists                  | &check; |         |
...
|Recursion/Search| 3.1 | DFS and Checked        | 1 | 79. Word Search                          | &check; |         |
...
|                | 3.3 | Trie Tree              | 1 | 208. Implement Trie                      |         | &check; |
...
| Recursion/Graph| 4.1 | Graph, DFS and Check cycle | 1 | 207. Course Schedule                 | &check; |         |
|                |     |                            | 2 | 210. Course Schedule II              | &check; |         |
|                |     |      | 3 | 323. Number of Connected Components in an Undirected Graph | &check; |         |
|                | 4.2 | Graph, BFS and Topological Sort | 1 | 207. Course Schedule            |         | &check; |
|                |     |                                 | 2 | 210. Course Schedule II         |         | &check; |
...
|                | 3.1 | Stack                  | 1 | 20. Valid Parentheses                    | &check; | &check; |
